...
const DEFAULT_BEHIND_GRADIENT =
  'radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(20,100%,70%,var(--card-opacity)) 4%,hsla(20,50%,60%,calc(var(--card-opacity)*0.75)) 10%,hsla(20,25%,50%,calc(var(--card-opacity)*0.5)) 50%,hsla(20,0%,40%,0) 100%),radial-gradient(35% 52% at 55% 20%,#F14A0044 0%,#C6230000 100%),radial-gradient(100% 100% at 50% 50%,#F14A00ff 1%,#C6230000 76%),conic-gradient(from 124deg at 50% 50%,#F14A00ff 0%,#C62300ff 40%,#C62300ff 60%,#F14A00ff 100%)';

const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg,#1f29378c 0%,#F14A0044 100%)';
